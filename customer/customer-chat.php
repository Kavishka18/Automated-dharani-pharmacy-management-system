          ...
          <div class="card shadow">
              ...
              <div class="chat-container">
                ...
                <div class="chat-body" id="chat-body">
                  <div class="message bot">
                    <strong>Hi! Welcome to Dharani Pharmacy Gampaha!</strong><br>
                    I'm your AI assistant. Ask me:<br>
                    • "Do you have Panadol?"<br>
                    • "What time do you open?"<br>
                    • "Are you closed on Poya day?"
                  </div>
                </div>
            ...
            <div class="card-footer text-center no-print">
              <small class="text-muted">
                <i class="fas fa-info-circle"></i> Powered by Local AI • Real-time stock from database
              </small>
            </div>
          </div>
        </div>
