...
?>
                ...
                <tr>
                  ...
                  <td><a href="edit-medicine.php?editid=<?php echo $row['ID'];?>" class="btn btn-primary btn-sm">Edit</a>
     <a href="manage-medicine.php?id=<?php echo $row['ID']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-danger btn-sm">Delete</a>
                  </td>
                </tr>
                <?php 
$cnt=$cnt+1;
