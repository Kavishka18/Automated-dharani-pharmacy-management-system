...
<style>
    ...
    .header { background: linear-gradient(87deg, #11998e, #38ef7d) !important; }
    .status-approved {
...
<p class="lead mb-0">Trusted by 5 Insurance Providers • Gampaha, Sri Lanka</p>
</div>
</div>
